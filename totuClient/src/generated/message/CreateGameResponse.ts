...
//   protoc               v3.21.7
// source: message/PlayerSession.proto
...
export const CreateGameResponse = {
  encode(message: CreateGameResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.gameId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CreateGameResponse {
