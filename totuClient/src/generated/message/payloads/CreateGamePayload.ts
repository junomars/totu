...
//   protoc               v3.21.7
// source: message/payloads/CreateGameRequest.proto
...
function createBaseCreateGamePayload(): CreateGamePayload {
  return { playerName: "", map: "", playerCount: 0, gameOrientation: 0 };
}

export const CreateGamePayload = {
  encode(message: CreateGamePayload, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CreateGamePayload {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCreateGamePayload();
  ...
  fromJSON(object: any): CreateGamePayload {
    return {
  ...
  toJSON(message: CreateGamePayload): unknown {
    const obj: any = {};
    if (message.playerName !== "") {
  ...
  create<I extends Exact<DeepPartial<CreateGamePayload>, I>>(base?: I): CreateGamePayload {
    return CreateGamePayload.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateGamePayload>, I>>(object: I): CreateGamePayload {
    const message = createBaseCreateGamePayload();
